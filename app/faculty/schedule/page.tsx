        ...
        >
            <div className="flex flex-col gap-2">
                ...
                <p className="text-slate-500 text-sm font-medium">
                    Select a shortlisted company and plan a visit for your students.
                </p>
            </div>
            ...
            >
                ...
                <p className="text-slate-500 text-sm max-w-sm mx-auto mb-6 leading-relaxed">
                    Start by contacting a company representative from your shortlist. Once confirmed, you can formalize the schedule here.
                </p>
