...
export default function StudentApplicationReportPage() {
    ...
    const loadApplication = async () => {
        try {
            setLoading(true)
            const currentSpamFlags = spamFlags;
    ...
    if (application.student.id !== user?.id) {
        if (typeof window !== 'undefined') router.push('/student/applications')
        return null;
    }
                ...
                <div className="bg-white border text-slate-900 border-slate-200/80 rounded-[24px] shadow-sm overflow-hidden">
                    ...
                    <div className="bg-slate-50/50 p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
                        <div>
                            ...
                            <p className="text-sm text-slate-500">This is your final evaluation dossier for this application.</p>
                        </div>
                    </div>
                </div>
                        ...
                        */}
                        <div className="mb-10 flex flex-col dossier-page border-b-2 border-slate-900 pb-8 pt-4">
                            <div className="flex flex-col mb-8 pb-6 border-b border-slate-100">
                                <h1 className="text-3xl font-black text-slate-900 tracking-tight mb-2">Your Evaluation Report</h1>
                                        ...
                                        <table className="w-full text-left">
                                            ...
                                            <tfoot className="bg-sky-900 text-white font-bold text-lg">
                                                <tr>
                                                    ...
                                                    <td className="p-4 text-right">{evaluation.calculationReceipt.academics.total} / 100</td>
                                                </tr>
                                            </tfoot>
                                        </table>
                                    </div>
                                        ...
                                        <table className="w-full text-left">
                                            ...
                                            <tfoot className="bg-emerald-900 text-white font-bold text-lg">
                                                <tr>
                                                    ...
                                                    <td className="p-4 text-right">{evaluation.calculationReceipt.docs.total} / 100</td>
                                                </tr>
                                            </tfoot>
                                        </table>
                                    </div>
                                        ...
                                        <table className="w-full text-left">
                                            ...
                                            <tfoot className="bg-indigo-900 text-white font-bold text-lg">
                                                <tr>
                                                    ...
                                                    <td className="p-4 text-right">{evaluation.calculationReceipt.github.total} / 100</td>
                                                </tr>
                                            </tfoot>
                                        </table>
                                    </div>
                                        ...
                                        <table className="w-full text-left">
                                            ...
                                            <tfoot className="bg-amber-900 text-white font-bold text-lg">
                                                <tr>
                                                    ...
                                                    <td className="p-4 text-right">{evaluation.calculationReceipt.leetcode.total} / 100</td>
                                                </tr>
                                            </tfoot>
                                        </table>
                                    </div>
