...
import { MapPin, Calendar, CheckCircle, User, Building2, CalendarClock, ArrowLeft } from "lucide-react"
    ...
    return (
        <div className="w-full h-full overflow-y-auto bg-slate-50/30">
            ...
            <div className="max-w-7xl mx-auto px-6 py-8">
                ...
                {/* Back Link */}
                <div className="mb-6">
                    <Link href="/student" className="inline-flex items-center text-sm font-medium text-slate-500 hover:text-slate-900 transition-colors">
                    ...
                    <div className="p-8 md:p-10 border-b border-slate-100 relative">
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                            ...
                            <div className="flex flex-col items-center">
                                ...
                                <Badge className="bg-sky-50 text-sky-600 hover:bg-sky-50 hover:text-sky-600 border-sky-100/50 px-3 py-1 text-xs rounded-md font-bold tracking-normal shadow-none inline-flex items-center gap-1.5">
                ...
                <div className="p-8 md:p-10 grid md:grid-cols-3 gap-12">
                            ...
                            <div className="flex flex-col sm:flex-row gap-6 items-start sm:items-center justify-between">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sky-600 font-medium text-sm">{company.representative.role}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="space-y-6">
                        <Card className="border-none shadow-lg bg-sky-600 text-white overflow-hidden relative">
                            ...
                            <CardContent className="p-6 relative z-10 space-y-6">
                                <div>
                                    ...
                                    <p className="text-sky-100 text-sm opacity-90">
                                        Express your interest to join this visit.
                                    </p>
                                </div>
